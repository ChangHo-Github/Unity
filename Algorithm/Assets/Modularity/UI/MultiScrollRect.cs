...
public class MultiScrollRect : ScrollRect
{
    ...
    {
        if (routeToParent) DoForParents<IDragHandler>((parent) =>
        {
    ...
    public override void OnBeginDrag(PointerEventData eventData)
    {
        ...
        if (routeToParent) DoForParents<IBeginDragHandler>((parent) =>
        {
    ...
    {
        if (routeToParent) DoForParents<IEndDragHandler>((parent) =>
        {
